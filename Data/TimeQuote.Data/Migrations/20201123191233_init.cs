        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    WeeklyLimit = table.Column<double>(nullable: false),
                    DailyLimit = table.Column<double>(nullable: false),
                    AllowedToWorkMonday = table.Column<bool>(nullable: false),
                    AllowedToWorkTuesday = table.Column<bool>(nullable: false),
                    AllowedToWorkWednesday = table.Column<bool>(nullable: false),
                    AllowedToWorkThursday = table.Column<bool>(nullable: false),
                    AllowedToWorkFriday = table.Column<bool>(nullable: false),
                    AllowedToWorkSaturday = table.Column<bool>(nullable: false),
                    AllowedToWorkSunday = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Limits_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectApplicationUsers", x => new { x.ApplicationUserId, x.ProjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectApplicationUsers_ProjectId",
